...
function freezing_field_explode( keys )
	...
	-- Get random point
	local castDistance = 400--RandomInt( minDistance, maxDistance )
	local angle = 0--RandomInt( 0, 90 )
	...
	print("Found units in radius: "..LogDeepToString(units))
	for k, v in pairs( units ) do
		...
		print("Attempting to deal damage with "..LogDeepToString(damageTable))
